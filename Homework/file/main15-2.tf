...
resource "yandex_storage_bucket" "vasya" {
  access_key = yandex_iam_service_account_static_access_key.sa-static-key.access_key
  secret_key = yandex_iam_service_account_static_access_key.sa-static-key.secret_key
  bucket     = "vasya-20-11-2000"
...
resource "yandex_storage_object" "object" {
  ...
  bucket     = "vasya-20-11-2000"
  key        = "elk.jpg"
  source     = "/home/user/bkt/elk.jpg"

}
resource "yandex_iam_service_account" "igsa" {
  name        = "igsa"
...
resource "yandex_lb_network_load_balancer" "ntlb-1" {
